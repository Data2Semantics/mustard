...
/**
 * 
 * Tree version (i.e. walks are counted in the Tree representation of the neighborhood) of {@link org.data2semantics.mustard.kernels.graphkernels.singledtgraph.DTGraphWalkCountIDEQKernel}.
 * 
 * @author Gerben
 *
 */
