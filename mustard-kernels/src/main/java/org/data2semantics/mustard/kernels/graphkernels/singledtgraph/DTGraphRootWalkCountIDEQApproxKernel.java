...
/**
 * 
 * Root version (i.e. only walks that start in the root node are counted) of {@link org.data2semantics.mustard.kernels.graphkernels.singledtgraph.DTGraphWalkCountIDEQApproxKernel}.
 * 
 * @author Gerben
 *
 */
public class DTGraphRootWalkCountIDEQApproxKernel implements GraphKernel<SingleDTGraph>, FeatureVectorKernel<SingleDTGraph>, ComputationTimeTracker, FeatureInspector {
	...
	public DTGraphRootWalkCountIDEQApproxKernel(int pathLength, int minFreq, boolean normalize) {
