...
/**
 * Wrapper kernel for {@link org.data2semantics.mustard.kernels.graphkernels.singledtgraph.DTGraphWalkCountIDEQApproxKernel}. 
 * 
 * @author Gerben
 */
public class RDFWalkCountIDEQApproxKernel implements GraphKernel<RDFData>, FeatureVectorKernel<RDFData>, ComputationTimeTracker, FeatureInspector {
	private int depth;
	private boolean inference;
	private DTGraphWalkCountIDEQApproxKernel kernel;
	private SingleDTGraph graph;

	public RDFWalkCountIDEQApproxKernel(int pathLength, int depth, boolean inference, int minFreq, boolean normalize) {
		super();
		this.depth = depth;
		this.inference = inference;
		kernel = new DTGraphWalkCountIDEQApproxKernel(pathLength, depth, minFreq, normalize);
	}
