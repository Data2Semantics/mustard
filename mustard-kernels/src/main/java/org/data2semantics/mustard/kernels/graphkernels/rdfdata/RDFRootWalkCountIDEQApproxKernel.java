...
/**
 * Wrapper kernel for {@link org.data2semantics.mustard.kernels.graphkernels.singledtgraph.DTGraphRootWalkCountIDEQApproxKernel}. 
 * 
 * @author Gerben
 */
public class RDFRootWalkCountIDEQApproxKernel implements GraphKernel<RDFData>, FeatureVectorKernel<RDFData>, ComputationTimeTracker, FeatureInspector {
	private int depth;
	...
	public RDFRootWalkCountIDEQApproxKernel(int pathLength, boolean inference, int minFreq, boolean normalize) {
		...
		kernel = new DTGraphRootWalkCountIDEQApproxKernel(pathLength, minFreq, normalize);
	}
