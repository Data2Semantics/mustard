...
/**
 * Wrapper kernel for {@link org.data2semantics.mustard.kernels.graphkernels.singledtgraph.DTGraphTreeWalkCountIDEQApproxKernelMkII}. 
 * 
 * @author Gerben
 */
public class RDFTreeWalkCountIDEQApproxKernelMkII implements GraphKernel<RDFData>, FeatureVectorKernel<RDFData>, ComputationTimeTracker, FeatureInspector {
	private int depth;
	private boolean inference;
	private DTGraphTreeWalkCountIDEQApproxKernelMkII kernel;
	private SingleDTGraph graph;

	public RDFTreeWalkCountIDEQApproxKernelMkII(int pathLength, int depth, boolean inference, int minFreq, boolean normalize) {
		super();
		this.depth = depth;
		this.inference = inference;

		kernel = new DTGraphTreeWalkCountIDEQApproxKernelMkII(pathLength, depth, minFreq, normalize);
	}
