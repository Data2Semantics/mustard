...
/**
 * A simple graph kernel to combine different graph kernels. This kernel simply computed all the graph kernels in the provided list and sums these kernels to one kernel matrix.
 * 
 * @author Gerben
 *
 */
