...
public class RDFTreeWLSubTreeIDEQApproxKernel implements GraphKernel<RDFData>, FeatureVectorKernel<RDFData>, ComputationTimeTracker {
	...
	public RDFTreeWLSubTreeIDEQApproxKernel(int iterations, int depth, boolean inference, boolean reverse, boolean iterationWeighting, boolean noDuplicateNBH, int[] maxPrevNBHs, int[] maxLabelCards, int[] minFreqs, boolean normalize) {
		super();
		this.depth = depth;
		this.inference = inference;

		kernel = new DTGraphTreeWLSubTreeIDEQApproxKernel(iterations, depth, reverse, iterationWeighting, noDuplicateNBH, maxPrevNBHs, maxLabelCards, minFreqs, normalize);
	}
